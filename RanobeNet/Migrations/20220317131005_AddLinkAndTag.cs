...
{
    public partial class AddLinkAndTag : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelLinks", x => new { x.NovelId, x.Link });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NovelTags", x => new { x.NovelId, x.Tag });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NovelTags_Tag_NovelId",
                table: "NovelTags",
                columns: new[] { "Tag", "NovelId" });
        }
